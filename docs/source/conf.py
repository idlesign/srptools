# -*- coding: utf-8 -*-
#
# srptools documentation build configuration file.
#
...
latex_documents = [
  ('index', 'srptools.tex', u'srptools Documentation',
...
man_pages = [
    ('index', 'srptools', u'srptools Documentation',
